...
@Component({
  selector:
    'app-hii-region-moderate-render',
  ...
  template: `
    ...
    >
      <canvas
        #canvas
        class="hii-moderate__canvas"
        role="img"
        [attr.aria-label]="descriptor().accessibleLabel"
      ></canvas>

      <div
        class="hii-moderate__optics"
        aria-hidden="true"
      ></div>
    </div>
  `,
  ...
  styles: [`
    ...
    .hii-moderate__canvas {
      display: block;
      width: 100%;
      height: 100%;
    }

    .hii-moderate__optics {
      position: absolute;
      inset: 0;
      pointer-events: none;
      background:
...
export class HiiRegionModerateRender
  implements
    AfterViewInit,
    OnDestroy {
  ...
  /* glsl */ `
    ...
    void main() {
      ...
      for (
        ...
        /*
         * MODERATE V1: keep the frozen LOW V2.2 morphology grammar, but let
         * the stronger model inputs produce wider ionized volumes, more
         * turbulence and a denser multi-source excitation field.
         */
