...
export enum GalacticObjectScientificActionType {
  ...
  /** 27.10 V2, appended; point-12.7 V1 actions retain their frozen order. */
  IMBH_COMPACT_CHARACTERIZATION =
    'IMBH_COMPACT_CHARACTERIZATION',

  IMBH_INDEPENDENT_CONFIRMATION =
    'IMBH_INDEPENDENT_CONFIRMATION',

  /** Galactic-centre V2 progression; appended without changing frozen rules. */
  ACTIVE_NUCLEUS_MULTIBAND_CHARACTERIZATION =
    'ACTIVE_NUCLEUS_MULTIBAND_CHARACTERIZATION',

  ACTIVE_NUCLEUS_INDEPENDENT_CONFIRMATION =
    'ACTIVE_NUCLEUS_INDEPENDENT_CONFIRMATION',
}
