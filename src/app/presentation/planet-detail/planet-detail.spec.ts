    ...
    it(
      ...
      async () => {
        ...
        expect(
          ...
          '/system/3/-17/8/planet/0?u=96F17ABD83F31EF747FC750C996EB1C2#planet-section-moons',
        );
        expect(
          fixture
            .componentInstance
          ...
          '/system/3/-17/8/planet/0?u=96F17ABD83F31EF747FC750C996EB1C2#planet-section-comparison',
        );
        expect(
          fixture
            .componentInstance
